...
export class UserService {
    ...
    post = servicewrapper((params: any) => {
        return this.instance.post(`api/user/`, params, {
            headers: AuthorizationHeader()
        }).then((res) => res.data);
    }, this)

    delete = servicewrapper((id: any) => {
        return this.instance.delete(`api/user/${id}`, {
            headers: AuthorizationHeader()
        }).then((res) => res.data);
    }, this)

    put = servicewrapper((params: any, id: any) => {
        return this.instance.put(`api/user/${id}`, params, {
            headers: AuthorizationHeader()
        }).then((res) => res.data);
    }, this)
}
